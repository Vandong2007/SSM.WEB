...
Public Class CurrentOnlineUserList
    ...
    Public Sub CheckLogin()
        ...
        If Session("TenDangNhap") IsNot Nothing Then
            _userticket = Session("TenDangNhap").ToString()
        End If
        If _userticket <> "" Then
            ...
            If _onlinetable.IsOnline_byTicket(Me.Session("TenDangNhap").ToString()) Then
                ' Update the last active time.
                _onlinetable.ActiveTime(Session("TenDangNhap").ToString())
            ...
            Else
                ...
                ' the page to LogoOut.D:\WEB.SSM\Account\Login.aspx
