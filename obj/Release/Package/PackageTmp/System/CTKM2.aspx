<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/homes.master" CodeBehind="CTKM2.aspx.vb" Inherits="WEB.SSM.CTKM2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1" FileName="DSCTKM"></dx:ASPxGridViewExporter>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxButton ID="Btsyns" runat="server" Text="Import CTKM ">
    ...
    <dx:ASPxGridView ID="ASPxGridView1"  runat="server" AutoGenerateColumns="False" DataSourceID="Sqlctkm" KeyFieldName="ID"
...
<PropertiesMemoEdit Width="100%"></PropertiesMemoEdit>
     ...
     <%--             <EditItemTemplate>
              ...
              <dx:ASPxGridLookup ID="GridLookup" runat="server"    SelectionMode="Multiple" DataSourceID="SqlDataSource1" ClientInstanceName="gridLookup"
                            KeyFieldName="MaCT" Width="100%" TextFormatString="{0}" MultiTextSeparator=";" Value='<%# Bind("khongapdung")%>' Caption="Mã chương trình">
                            <Columns>
        ...
        <Templates>
            <EditForm>
             ...
             <%--   <% if(!ASPxGridView1.IsNewRowEditing) { %>
                    ...
                    <dx:ASPxPageControl runat="server" ID="pageControl" Width="95%">
                        <TabPages>
                                    ...
                                    <dx:ContentControl ID="ContentControl1" runat="server" Width="95%">
                                      <dx:ASPxGridViewTemplateReplacement ID="Editors" ReplacementType="EditFormEditors"
                                       ...
                                       <%-- <table class="OptionsTable" style="width: 100%">
                                            <tr>
                                                <td style="white-space: nowrap">Mã chương trình
                                                </td>
                                                <td style="width: 50%">
                                                    <dx:ASPxTextBox runat="server" ID="edFirst" Text='<%# Bind("MaCT")%>' Width="100%">
                                                    </dx:ASPxTextBox>
                                                </td>
                                                <td style="white-space: nowrap">Nhóm sản phẩm
                                                </td>
                                                <td style="width: 50%">
                                                    <dx:ASPxTextBox runat="server" ID="eBrand" Text='<%# Bind("NhanSP")%>' Width="100%">
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                        </table>--%>
                ...
                <br />
                                        ...
                                        <dx:ASPxGridView ID="ASPspa" runat="server" AutoGenerateColumns="False" DataSourceID="SqlAd" KeyFieldName="Id" OnBeforePerformDataSelect="Girlad_DataSelect" OnInitNewRow="Girlad_InitNewRow" Width="95 %">
                                            <Columns>
                  ...
                  <%--                              <dx:GridViewDataColumn Caption="Combo" VisibleIndex="9" Width="15%">
                <DataItemTemplate>
                    <a href="javascript:void(0);" onclick="OnMoreInfoClick(this, '<%# Container.KeyValue %>')">
                        combo</a>
                </DataItemTemplate>
            </dx:GridViewDataColumn> --%>
                                               <%-- <dx:GridViewDataTextColumn FieldName="soluong" VisibleIndex="9">
                                                </dx:GridViewDataTextColumn>--%>
...
<%-- <dx:ASPxPageControl runat="server" ID="pageControl" Width="100%">
                        <TabPages>
                            <dx:TabPage Text="Đối tượng khuyến mãi chính" Visible="true">
                                <ContentCollection>
...
IncrementalFilteringMode = Contains  Width="100%">
                                                        ...
                                                        <tr>
                                                              ...
                                                              <td> Áp Dụng  </td>
                                                            <td>
                                                                <dx:ASPxCheckBox runat="server" ID="ASPxTextBox3"  Checked = '<%# Bind("Apdung")%>'  Text ="không check là không áp dụng" >
                                                                  </dx:ASPxCheckBox >
                                                            </td>
...
on CASE WHEN b.ValueColumn <> 'ALL' AND b.ValueColumn IS NOT NULL   THEN b.ValueColumn ELSE a.Brand  END = a.Brand  where a.nhan <>'' group by a.nhan 
...
THEN f.ValueColumn ELSE a.Volumn  END = a.Volumn
 ...
 group by a.Itemcode, a.Itemname
    ...
    <dx:ASPxGridView ID="ASPcombo" runat="server" AutoGenerateColumns="False" DataSourceID="Sqlcombo" KeyFieldName="combo" OnBeforePerformDataSelect="Girlcb_DataSelect" OnInitNewRow="Girlcb_InitNewRow">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <tr>
                                                            <td>Loại sản phẩm
                                                             ...
                                                             <%--  Text ='<%# Bind("Type")%>'--%>
                                                              <td colspan="8">
                                                                  <dx:ASPxComboBox ID="type" runat="server" TextField ='<%# Bind("Type")%>' Text ='<%# Eval("Type")%>' TextFormatString=" {0} " Caption="Loại"      dropdownstyle="DropDown">
                                                                       <Items>
...
THEN f.ValueColumn ELSE a.Volumn  END = a.Volumn
 ...
 group by a.Itemcode, a.Itemname 
                ...
                <asp:SqlDataSource ID="Sqlcombo" runat="server" ConnectionString="<%$ ConnectionStrings:SSMConnectionString %>" DeleteCommand="DELETE FROM [tbdtcombo] WHERE [combo] = @combo" InsertCommand="INSERT INTO [tbdtcombo] ( Type,[MS_CTKM], [Brand], [Nhan], [Mui], [Loai], [Size], [MaSP], [soluong],   [Users], [dates] ) VALUES ( @Type, @MS_CTKM, @Brand, @Nhan, @Mui, @Loai, @Size, @MaSP, @soluong,   @Users, Getdate() )" SelectCommand="SELECT * FROM [tbdtcombo] WHERE ([MS_CTKM] = @MS_CTKM)" UpdateCommand="UPDATE [tbdtcombo] SET Type=@Type, [MS_CTKM] = @MS_CTKM, [Brand] = @Brand, [Nhan] = @Nhan, [Mui] = @Mui, [Loai] = @Loai, [Size] = @Size, [MaSP] = @MaSP, [soluong] = @soluong,   [Users] = @Users, [dates] = Getdate()  WHERE [combo] = @combo">
                    <DeleteParameters>
                ...
                <br />
                                        ...
                                        <dx:ASPxGridView ID="GirlKM" runat="server" AutoGenerateColumns="False" DataSourceID="Sqls" KeyFieldName="ID" OnBeforePerformDataSelect="GirlKM_DataSelect" OnInitNewRow="GirlKM_InitNewRow" Width="95%">
                                            <Columns>
                                                <dx:GridViewCommandColumn VisibleIndex="0">
                                                    <EditButton Visible="True">
                                                    </EditButton>
...
THEN f.ValueColumn ELSE a.Volumn  END = a.Volumn
 ...
 group by a.Itemcode, a.Itemname 
                                        ...
                                        <asp:SqlDataSource ID="Sqls" runat="server" ConnectionString="<%$ ConnectionStrings:SSMConnectionString %>" DeleteCommand="DELETE FROM [tbdtKhuyenmai] WHERE id = @ID " InsertCommand="INSERT INTO [tbdtKhuyenmai] ([MS_CTKM], [Brand], [Nhan], [Mui], [Size], [MaSP], [Users], [dates],Loai,LoaiMua,Value,LoaiKM,Valuekm) VALUES (@MS_CTKM, @Brand, @Nhan, @Mui, @Size, @MaSP,  @Users, getdate(),@Loai,left(@LoaiMua,1),@Value,left(@LoaiKM,1),@Valuekm)" SelectCommand="SELECT * FROM [tbdtKhuyenmai] where ([MS_CTKM] = @MS_CTKM)" UpdateCommand="UPDATE [tbdtKhuyenmai] SET   [Brand] = @Brand, [Nhan] = @Nhan, [Mui] = @Mui, [Size] = @Size, [MaSP] = @MaSP,  [Users] = @Users, [dates] = getdate(),loai=@Loai,LoaiMua=left(@LoaiMua,1),Value=@value,LoaiKM=left(@LoaiKM,1),Valuekm =@Valuekm WHERE  Id=@ID">
                                            <DeleteParameters>
                ...
                <br />
                                        ...
                                        <dx:ASPxGridView ID="ASPxGridqd" runat="server" AutoGenerateColumns="False" DataSourceID="Sqlqd" KeyFieldName="ID" OnBeforePerformDataSelect="Girlqd_DataSelect" OnInitNewRow="Girlqd_InitNewRow" Width="95%">
                                            <Columns>
                                                <dx:GridViewCommandColumn VisibleIndex="0">
                                                    <EditButton Visible="True">
                                                    </EditButton>
...
THEN f.ValueColumn ELSE a.Volumn  END = a.Volumn
 ...
 group by a.Itemcode, a.Itemname
                ...
                <br />
                <br />
                                        <dx:ASPxGridView ID="GirlNpp" runat="server" AutoGenerateColumns="False" DataSourceID="Sqlnpp" KeyFieldName="ID" OnBeforePerformDataSelect="GirlNpp_DataSelect" OnInitNewRow="GirlNpp_InitNewRow">
                                            <Columns>
                                                <dx:GridViewCommandColumn VisibleIndex="0">
                                                    <EditButton Visible="True">
                                                    </EditButton>
                ...
                <dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" ClientInstanceName="callbackPanel" runat="server"
                    ...
                    <PanelCollection>
                        ...
                        <dx:ListEditItem Text="KM Khuyến Dùng" Value="KMKD" />
                            ...
                            KeyFieldName="MaCT"   TextFormatString="{0}" MultiTextSeparator=";"   Caption="Mã chương trình">
                            <Columns>
                                <dx:GridViewDataColumn FieldName="MaCT" Width="100%" />
...
<%--    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SSMConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand=" select  ID,[MaCT],[TenCT],[NhanSP],[LoaiCT],[TyleCK],[Ngaybd] ,[Ngaykt],[Type],[Ngansach], [khongapdung]  from ( select * FROM tbCTKM Where ngaybd <=@date1  and ngaykt>= @date2 union all select * FROM tbCTKM Where ngaybd > @date1  and ngaybd<= @date2 union all select * FROM tbCTKM Where ngaykt >@date1 and ngaykt< @date2 ) b group by  id,[MaCT],[TenCT],[NhanSP],[LoaiCT],[TyleCK],[Ngaybd] ,[Ngaykt],[Type],[Ngansach],[SoluongSKu],[khongapdung] ORDER BY [Ngaybd] DESC"
         DeleteCommand="DELETE FROM [tbCTKM] WHERE [MaCT] = @original_MaCT " InsertCommand="INSERT INTO [tbCTKM] ([MaCT], [TenCT], [NhanSP], [LoaiCT], [TyleCK], [Ngaybd], [Ngaykt], [Type], [Ngansach],  [Users], [dates],khongapdung) VALUES (@MaCT, @TenCT, @NhanSP, @LoaiCT, @TyleCK, @Ngaybd, @Ngaykt, @Type, @Ngansach,   @Users, getdate(),@khongapdung)" UpdateCommand="UPDATE [tbCTKM] SET  [TenCT] = @TenCT, [NhanSP] = @NhanSP, [LoaiCT] = @LoaiCT, [TyleCK] = @TyleCK, [Ngaybd] = @Ngaybd, [Ngaykt] = @Ngaykt, [Type] = @Type, [Ngansach] = @Ngansach,  [Users] = @Users, [dates] = Getdate(), khongapdung = @khongapdung WHERE [MaCT] = @original_MaCT ">
        <DeleteParameters>
            <asp:Parameter Name="original_MaCT" />
        </DeleteParameters>
        <InsertParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:SSMConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT Debcode, Debname, Debadd, Region, Subregion, Area, Province FROM dbo.Fn_cust(@uname) AS Fn_cust_1">
     ...
     <asp:SqlDataSource ID="Sqlctkm" runat="server" ConnectionString="<%$ ConnectionStrings:SSMConnectionString %>" DeleteCommand="DELETE FROM tbCTKM WHERE (ID = @ID)" SelectCommand="select * from tbCTKM where (Ngaybd<=@date1 and ngaykt>=@date2)  or (Ngaybd >  @date1 and ngaybd<= @date2) or (Ngaykt >  @date1 and ngaykt< @date2)" UpdateCommand="UPDATE [tbCTKM] SET  [TenCT] = @TenCT, [NhanSP] = @NhanSP, [LoaiCT] = @LoaiCT, [TyleCK] = @TyleCK, [Ngaybd] = @Ngaybd, [Ngaykt] = @Ngaykt, [Type] = @Type, [Ngansach] = @Ngansach, [SoluongSKu] = 0, [khongapdung] = @khongapdung, [Users] = @Users, [dates] =Getdate() WHERE ID = @ID">
                    <DeleteParameters>
