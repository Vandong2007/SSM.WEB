...
Public Class CTKM2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If xem = 0 Or xem = 3 Then
            ...
            Else
                ...
                btchays.Visible = False
                Btsyns.Visible = False
    ...
    Protected Sub btCreate_Click(sender As Object, e As EventArgs) Handles btCreate.Click
        ...
        Dim dtb As DataTable = copyctkm(Session("TenDangNhap"), fMS_CTKM.Text, tMS_CTKM.Text)
        num = Integer.Parse("0" + dtb.Rows(0)(0))
        ...
        End If
    End Sub
    Private Function copyctkm(use As String, nguon As String, dich As String) As DataTable
        Dim arrParam As SqlParameter() = {New SqlParameter("@Username", SqlDbType.NVarChar), New SqlParameter("@CTKM_nguon", SqlDbType.NVarChar), New SqlParameter("@CTKM_dich", SqlDbType.NVarChar)}
        arrParam(0).Value = use
        arrParam(1).Value = nguon
        arrParam(2).Value = dich

        Return oj.ThucThiStore_DataSets("copyctkm", arrParam).Tables(0)
